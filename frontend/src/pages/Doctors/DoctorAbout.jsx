        ...
        <div>
            <div>
                <h3 className="text-[20px] leading-[30px] text-headingColor font-semibold flex items-center gap-2 "> 
                    About of  <span className="text-irisBlueColor font-bold text-[24px] leading-9">
                      {name}
            ...
            <div className="mt-12">
                ...
                <ul className="pt-4 md:p-5">
                    {qualifications?.map((item,index)=><li key={index} className="flex felx-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px] ">
