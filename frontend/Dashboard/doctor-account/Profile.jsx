...
const Profile = ({doctorData}) => {
  ...
  useEffect(()=>{
    ...
    const addExperience = e=>{
        ...
        addItem('experiences', {
             startingDate:"", endingDate:"", position:"Senior Surgeon", hospital:"KMC"
            })
    ...
    const addTimeSlot = e=>{
        ...
        addItem('timeSlots',  { day:"Sunday", startingTime:"10:00", endingTime:"4:30"})
    ...
    <div>
      ...
      <form >
        ...
        <div className="mb-5">
            ...
            <input type="email" name="name" value={formData.email}  onChange={handleInputChange}
            placeholder="Email"
            className="form_input"
            readOnly
            aria-readonly
        ...
        <div className="mb-5">
            ...
            <button onClick={addQualification} className="bg-black py-2 px-5 rounded text-white h-fit cursor-pointer">
        ...
        <div className="mb-5">
            ...
            <button onClick={addExperience} className="bg-black py-2 px-5 rounded text-white h-fit cursor-pointer">Add Experience</button>
        ...
        <div className="mb-5">
            ...
            <button onClick={addTimeSlot} className="bg-black py-2 px-5 rounded text-white h-fit cursor-pointer">
                Add TimeSlot
                </button>
